...
const ERROR_HINTS_RU = {
  ...
  invalid_class: "Выберите класс из списка.",
  ...
  specialization_locked: "Специализация уже выбрана. Изменить её может DM.",
  specialization_xp_required: "Специализация откроется после нужного количества XP.",
  invalid_specialization: "Выберите специализацию из доступных для этого класса.",
  invalid_xp_amount: "Укажите XP от -1000 до 1000, кроме нуля.",
  xp_no_change: "XP не изменился. Проверьте значение.",
  ...
  daily_shop_limit: "Подождите до следующего дня или попросите DM увеличить лимит лавки.",
